...
<tr id="row-<?php echo $row["id"] ?>">
    ...
    <div class="btn-group align-top">
        ...
        data-target="#confirm-delete-modal" class="btn btn-sm btn-outline-secondary badge call-modal-delete-user" type="button"><i data-id="<?php echo $row["id"]?>" data-toggle="modal"
